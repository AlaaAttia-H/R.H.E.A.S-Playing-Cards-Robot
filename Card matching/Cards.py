...
# Width and height of card corner, where rank and suit are located
CORNER_WIDTH = 32
CORNER_HEIGHT = 84
...
def match_card(qCard, train_ranks, train_suits):
    """Finds the best rank and suit match for the query card. Differences
    ...
    # If no contours were found in the query card in the preprocess_card function,
    ...
    if len(qCard.rank_img) != 0 and len(qCard.suit_img) != 0:
        ...
        # Difference the query card suit image from each of the train suit images,
        # and store the result with the least difference
